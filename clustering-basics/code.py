...
for i in range(0,5):
    ...
    if (counts.index[0]=='Champagne'):
        # add it to 'champagne'
        champagne.update({i:counts.iloc[0]})

# get cluster with maximum orders of 'Champagne' 
cluster_champagne = max(champagne, key=champagne.get)

# print out cluster number
print('Cluster Purchasing most champagne: {}'.format(cluster_champagne))
...
print('Maximum discount cluster: {}'.format(cluster_discount))
# Code ends here
